...
if (isset($_POST['submit'])) {    
    ...
    if (empty($nama) || empty($usia) || empty($alamat) || empty($phone) || empty($password)) {
        echo "<font color='red'>Please fill in all fields.</font><br/>";
        echo "<br/><a href='javascript:self.history.back();'>Go Back</a>";
    } else { 

        $siswa = mysqli_query($mysqli, "INSERT INTO siswa (`nama`, `usia`, `alamat`, `phone`) VALUES ('$nama', '$usia', '$alamat', '$phone')");
        $id_siswa = mysqli_insert_id($mysqli);

		$auth = mysqli_query($mysqli, "INSERT INTO account (`id_siswa`, `id_tutor`, `id_admin`, `username`, `password`) VALUES ('$id_siswa', NULL, NULL, '$phone', '$password')");
        if ($auth) {
